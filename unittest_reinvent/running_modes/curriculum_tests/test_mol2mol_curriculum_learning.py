...
from running_modes.configurations.automated_curriculum_learning.automated_curriculum_learning_input_configuration import \
    AutomatedCurriculumLearningMol2MolInputConfiguration
...
from unittest_reinvent.fixtures.test_config import MAIN_TEST_PATH, PRIOR_PATH, MOL2MOL_PRIOR_PATH
from unittest_reinvent.fixtures.test_data import CELECOXIB


@pytest.mark.integration
class TestMol2MolCurriculumLearning(unittest.TestCase):
    ...
    def setUp(self):
        ...
        prior_config = ModelConfiguration(model_type.MOL2MOL, model_regime.INFERENCE, MOL2MOL_PRIOR_PATH)
        agent_config = ModelConfiguration(model_type.MOL2MOL, model_regime.INFERENCE, MOL2MOL_PRIOR_PATH)
    ...
    def _create_configuration(self, smiles):
        ...
        learning_strategy = LearningStrategyConfiguration(parameters={"sigma": 120}, name=self.learning_strategy_enum.DAP_MOL2MOL)

        curriculum_config = CurriculumStrategyInputConfiguration(name=self.cs_enum.MOL2MOL,
                                                                 input=smiles,
        ...
        production_config = ProductionStrategyInputConfiguration(name=self.ps_enum.MOL2MOL,
                                                                 scoring_function=
                                                            ScoringFunctionParameters(
        ...
        automated_cl_parameters = AutomatedCurriculumLearningMol2MolInputConfiguration(agent=PRIOR_PATH,
