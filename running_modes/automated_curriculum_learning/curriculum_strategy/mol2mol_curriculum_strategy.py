...
from running_modes.automated_curriculum_learning.actions.mol2mol_sample_model import Mol2MolSampleModel
...
class Mol2MolCurriculumStrategy(BaseCurriculumStrategy):
    ...
    def _sampling(self, agent) -> List[SampledSequencesDTO]:
        sampling_action = Mol2MolSampleModel(agent, self._parameters.batch_size, self._logger,
