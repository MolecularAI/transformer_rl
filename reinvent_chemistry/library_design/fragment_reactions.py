...
class FragmentReactions:
    ...
    def apply_reactions_on_molecule(self, molecule: Mol, reaction_dtos: List[ReactionDTO]) -> List[ReactionOutcomeDTO]:
        ...
        for reaction_dto in reaction_dtos:
            ...
            if len(purged_outcome_dto.reaction_outcomes) > 0 and purged_outcome_dto.targeted_molecule:
    ...
    def apply_reaction_on_molecule(self, molecule: Mol, reaction_dto: ReactionDTO) -> ReactionOutcomeDTO:
        ...
        try:
            ...
            print('Failed: ', self._conversions.mol_to_smiles(molecule))
            print(e)
            outcome_dto = ReactionOutcomeDTO(reaction_dto.reaction_smarts, [], molecule)
        return outcome_dto
    ...
    def _filter_pairs_with_no_ring_count_change(self, outcome_dto: ReactionOutcomeDTO) -> ReactionOutcomeDTO:
        ...
        try:
            ...
            print('Failed', self._conversions.mol_to_smiles(outcome_dto.targeted_molecule),
                  ' at _filter_pairs_with_no_ring_count_change ')
            print(e)
