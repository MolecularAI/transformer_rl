...
from reinvent_models.mol2mol.mol2mol_model import EncoderDecoder, Mol2MolModel
from reinvent_models.mol2mol.models.vocabulary import Vocabulary, SMILESTokenizer

from running_modes.configurations.create_model.mol2mol_create_model_configuration import \
    Mol2MolCreateModelConfiguration
...
class Mol2MolCreateModelRunner:
    def __init__(self, configuration: Mol2MolCreateModelConfiguration, logger: BaseCreateModelLogger):
