...
from running_modes.configurations.automated_curriculum_learning.automated_curriculum_learning_input_configuration import \
    AutomatedCurriculumLearningInputConfiguration, AutomatedCurriculumLearningMol2MolInputConfiguration
...
class CurriculumLearningModeConstructor:
    ...
    def _create_automated_curriculum(configuration):
        ...
        elif model_type.MOL2MOL == configuration.model_type:
            config = AutomatedCurriculumLearningMol2MolInputConfiguration.parse_obj(configuration.parameters)
