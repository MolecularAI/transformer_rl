...
class SampleFromMol2MolRunner(BaseRunningMode):

    def __init__(self, main_config: GeneralConfigurationEnvelope, configuration: SampleFromModelConfiguration):
        self._model = Mol2MolAdapter(configuration.model_path, mode=ModelModeEnum.INFERENCE)
    ...
    def run(self):
        ...
        target_smiles = []
        print(self._target_smiles_path)
