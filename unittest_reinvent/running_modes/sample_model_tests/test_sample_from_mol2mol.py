...
from unittest_reinvent.fixtures.test_config import MAIN_TEST_PATH, MOL2MOL_PRIOR_PATH
...
class TestSampleFromModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.num_smiles = 100
        self.config = SampleFromModelConfiguration(model_path=MOL2MOL_PRIOR_PATH,
    ...
    def test_sample_from_model_multinomial_without_likelihood(self):
        runner = SampleFromMol2MolRunner(self.configurationenvelope, self.config)
        runner.run()
